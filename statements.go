...
resolution`
	...
	// TODO deprecate
	READ_MANY_CONTENT           = "SELECT " + CONTENT_FIELDS + " FROM " + CONTENT_TABLE + " ORDER BY created DESC LIMIT ?, ?"
	READ_MANY_CONTENT_OF_AUTHOR = "SELECT " + CONTENT_FIELDS + " FROM " + CONTENT_TABLE + " WHERE author=? ORDER BY created DESC LIMIT ?, ?"
